...
(function() {
  angular.module('lm.linbo', ['core', 'lm.common', 'angular-sortable-view', 'colorpicker.module']);
...
(function() {
  ...
  angular.module('lm.linbo').controller('LMImportDevicesApplyModalController', function($scope, $http, $uibModalInstance, $route, gettext, notify) {
  ...
  angular.module('lm.linbo').controller('LMLINBOController', function($q, $scope, $http, $uibModal, $log, $route, $location, gettext, notify, pageTitle, tasks, messagebox, validation) {
    var tag;
