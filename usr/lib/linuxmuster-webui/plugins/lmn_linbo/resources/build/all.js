...
(function() {
  ...
  angular.module('lm.linbo').controller('LMLINBOController', function($scope, $http, $uibModal, $log, $route, $location, gettext, notify, pageTitle, tasks, messagebox, validation) {
    var tag;
