...
// Generated by CoffeeScript 2.3.1
(function() {
  angular.module('lm.users').controller('LMNUserDetailsController', function($scope, $route, $uibModal, $uibModalInstance, $http, gettext, notify, messagebox, pageTitle, id) {
    //notify.error gettext("You have to enter a username")
    $scope.id = id;
    $http.post('/api/lm/sophomorixUsers/students', {
      ...
      return console.log($scope.students);
    });
    //$scope.save = (username) ->
